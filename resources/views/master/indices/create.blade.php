<x-app-layout>
<x-slot name="title">New Index</x-slot>
...
<div class="card card-etrm mb-3" style="max-width:760px;">
    <div class="card-header">New Index / Curve</div>
    <div class="card-body">
        <div class="row g-3">
            <div class="col-12">
                <label class="form-label fw-semibold">Index Name *</label>
                <input type="text" name="index_name" class="form-control @error('index_name') is-invalid @enderror"
                       value="{{ old('index_name') }}" required placeholder="Brent 1M, TTF Day-Ahead...">
                @error('index_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="market" class="form-control" value="{{ old('market') }}" placeholder="Crude Oil, Natural Gas, Power">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Index Group</label>
                <input type="text" name="index_group" class="form-control" value="{{ old('index_group') }}">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Index Sub-Group</label>
                <input type="text" name="index_subgroup" class="form-control" value="{{ old('index_subgroup') }}">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Format *</label>
                <select name="format" class="form-select" required>
                    @foreach(['Monthly','Daily','Quarterly','Annual'] as $f)
                    <option value="{{ $f }}" {{ old('format','Monthly') == $f ? 'selected' : '' }}>{{ $f }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Class</label>
                <input type="text" name="class" class="form-control" value="{{ old('class') }}" placeholder="Energy, Metal...">
            </div>
            <div class="col-md-4">
                ...
                <select name="index_type" class="form-select">
                    ...
                    <option value="{{ $t }}" {{ old('index_type') == $t ? 'selected' : '' }}>{{ $t }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
                ...
                <select name="base_currency_id" class="form-select">
                    ...
                    <option value="{{ $c->id }}" {{ old('base_currency_id') == $c->id ? 'selected' : '' }}>{{ $c->code }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <select name="status" class="form-select" required>
                    ...
                    <option value="{{ $s }}" {{ old('status','Custom') == $s ? 'selected' : '' }}>{{ $s }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
                ...
                <select name="rec_status" class="form-select" required>
                    ...
                    <option value="{{ $s }}" {{ old('rec_status','Authorized') == $s ? 'selected' : '' }}>{{ $s }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
                ...
                <select name="version_status" class="form-select">
                    ...
                    <option value="{{ $s }}" {{ old('version_status','Pending') == $s ? 'selected' : '' }}>{{ $s }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="text" name="delivery_unit" class="form-control" value="{{ old('delivery_unit') }}" placeholder="MW, BBL/d...">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Date Sequence</label>
                <input type="text" name="date_sequence" class="form-control" value="{{ old('date_sequence') }}" placeholder="Calendar, Business...">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Payment Convention</label>
                <input type="text" name="payment_convention" class="form-control" value="{{ old('payment_convention') }}" placeholder="Following, Modified...">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Coverage End Date</label>
                <input type="date" name="coverage_end_date" class="form-control" value="{{ old('coverage_end_date') }}">
            </div>
            <div class="col-md-4">
                ...
                <select name="interpolation" class="form-select">
                    ...
                    <option value="{{ $i }}" {{ old('interpolation') == $i ? 'selected' : '' }}>{{ $i }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Projection Method</label>
                <input type="text" name="projection_method" class="form-control" value="{{ old('projection_method') }}" placeholder="Flat, Seasonal...">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Reference Source</label>
                <input type="text" name="reference_source" class="form-control" value="{{ old('reference_source') }}" placeholder="Platts, Argus...">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Day Start Time</label>
                <input type="time" name="day_start_time" class="form-control" value="{{ old('day_start_time') }}">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Holiday Schedule</label>
                <input type="text" name="holiday_schedule" class="form-control" value="{{ old('holiday_schedule') }}" placeholder="UK, US, TARGET...">
            </div>
            <div class="col-md-6">
                ...
                <select name="discount_index_id" class="form-select">
                    ...
                    <option value="{{ $idx->id }}" {{ old('discount_index_id') == $idx->id ? 'selected' : '' }}>{{ $idx->index_name }}</option>
                    @endforeach
                </select>
            </div>
...
<div class="d-flex gap-2 mb-4" style="max-width:760px;">
    <button type="submit" class="btn btn-primary" style="background:var(--etrm-secondary);border-color:var(--etrm-secondary);">Create Index</button>
    <a href="{{ route('master.indices.index') }}" class="btn btn-outline-secondary">Cancel</a>
</div>
</form>
</x-app-layout>
